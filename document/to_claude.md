...
- 수정: `document/TEMPLATES.md`
- 수정: `document/TEMPLATE_GUIDE.md`
- 수정: `document/MCP_TOOLS.md`
- 수정: `document/WORKFLOW.md`
- 수정: `document/ARCHITECTURE.md`
- 수정: `document/API_REFERENCE.md`
- 수정: `document/SECURITY.md`
- 수정: `document/FRONTEND_GUIDE.md`
- 수정: `document/README.md`
- 추가: `document/PDF_RENDER_GUIDE.md`
